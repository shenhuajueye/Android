...
public class MyStarCommunityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MyStarCommunityAdapter(Context context,List<Community> communities){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mystar_community,viewGroup,false);
        View footView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.foot_item,viewGroup,false);
        if(viewType == F_TYPE){
            return new MyStarCommunityAdapter.RecyclerViewHolder(footView,F_TYPE);
        }else {
            return new MyStarCommunityAdapter.RecyclerViewHolder(view,N_TYPE);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(isFootView&&getItemViewType(position)==F_TYPE){
            //底部加载提示
            final MyStarCommunityAdapter.RecyclerViewHolder recyclerViewHolder = (MyStarCommunityAdapter.RecyclerViewHolder) holder;
    ...
    private class RecyclerViewHolder extends RecyclerView.ViewHolder {
        public TextView communityName,communityInfo,communityUser; //mystar_community的TextView
        public TextView loading;
        public RecyclerViewHolder(View itemView, int view_type) {
            super(itemView);
            if(view_type==N_TYPE){
                communityName =itemView.findViewById(R.id.myStarCommunityName);
                communityInfo = itemView.findViewById(R.id.myStarCommunityInfo);
                communityUser = itemView.findViewById(R.id.myStarCommunityUser);
